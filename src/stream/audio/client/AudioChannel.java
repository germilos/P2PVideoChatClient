...
public class AudioChannel extends Thread {
    ...
    private ArrayList<SoundMessage> queue = new ArrayList<SoundMessage>(); //queue of messages to be played
    ...
    public void addToQueue(SoundMessage m) { //adds a message to the play queue
        queue.add(m);
    }
